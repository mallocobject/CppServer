...
int main()
{
    ...
    std::string str = "GET /hello?a=2 HTTP/1.1\r\n"
                      ...
                      "Yzg5ZjA1OGU0MWQ1NGNlMWI2MGQwYTFhMDAxYzY3YzU=|"
    ...
    bool flag = context->parseRequest(str.c_str(), str.size());
    std::cout << "http parser state: " << flag << std::endl;
    ...
    for (auto it : request->getHeaderParams())
    {
